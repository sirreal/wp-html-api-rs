    ...
    pub fn get_qualified_attribute_name(&self, attribute_name: &[u8]) -> Option<Box<[u8]>> {
        ...
        Some(match self.get_namespace() {
            ...
            ParsingNamespace::Svg => match lower_name.as_slice() {
                ...
                _ => attribute_name.into(),
            }
            .into(),
            ParsingNamespace::Html => match lower_name.as_slice() {
                b"xlink:actuate" => b"xlink actuate".as_slice(),
                b"xlink:arcrole" => b"xlink arcrole",
                b"xlink:href" => b"xlink href",
                b"xlink:role" => b"xlink role",
                b"xlink:show" => b"xlink show",
                b"xlink:title" => b"xlink title",
                b"xlink:type" => b"xlink type",
                b"xml:lang" => b"xml lang",
                b"xml:space" => b"xml space",
                b"xmlns" => b"xmlns",
                b"xmlns:xlink" => b"xmlns xlink",
                _ => attribute_name,
            }
            .into(),
            _ => attribute_name.into(),
